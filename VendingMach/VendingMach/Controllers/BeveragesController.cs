...
namespace VendingMach.Controllers
{
    public class BeveragesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Price,Count")] Beverage beverage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Price,Count")] Beverage beverage)
        {
            if (ModelState.IsValid)
            {
